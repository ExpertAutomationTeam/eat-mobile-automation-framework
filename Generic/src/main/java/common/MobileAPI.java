    ...
    public void setUp(String OS,String appType,String deviceType,String deviceName,
        ...
        if(OS.equalsIgnoreCase("ios")){
            if(appType.contains("iPhone")){
                appDirectory = new File("/Users/nacer-zimu/Library/Developer/Xcode/DerivedData/UIKitCatalog-giatdpakchrajygrtwphyjfnccos/Build/Products/Debug-iphonesimulator/UIKitCatalog.app");
            ...
            if(appType.contains("Phone")){
                ...
                findApp = new File("/Users/nacer-zimu/Mobile/MobileTesting/Mobile-AutomationJuly2019/NYP/src/app/nyp.apk");
                if(deviceType.equalsIgnoreCase("RealDevice")){
                    cap = new DesiredCapabilities();
                    cap.setCapability(MobileCapabilityType.DEVICE_NAME,deviceName);
